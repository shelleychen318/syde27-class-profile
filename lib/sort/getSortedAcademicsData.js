...
export async function getSortedAcademicsData() {
  ...
  const difficultCourseValues = Object.values(sortByDescendingValue(difficultCourse));
  const difficultCourseRespondents = difficultCourseValues.reduce((a, b) => a + b, 0);
