...
export async function getSortedLifestyleData() {
  ...
  for (var object in data) {
    ...
    //       if (!purityVsAverage[range.min]) {
    //         purityVsAverage[range.min] = [parseInt(data[object].average)];
    //       }
    //       // if range already exists, append the value to the array
    //       else {
    //         purityVsAverage[range.min].push(parseInt(data[object].average));
    //       }
    //     }
    //     if (purityVsAverage[range.min] == null) {
    //       purityVsAverage[range.min] = 0;
    //     }
    //   }
    // }
